...
//            true
//        }
        viewBinding.drQuestionsRecycler.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
                ...
                if (lastVisibleItemPosition == totalItemCount - 1) {
                    viewBinding.btnPublish.visibility = View.VISIBLE
                } else {
                    viewBinding.btnPublish.visibility = View.GONE
                }
            }
        })
        viewBinding.btnPublish.setOnClickListener {
            createQuiz()
        }
    }
    ...
    private fun createQuiz() {
        ...
        val questions = DrQuizItem(notes,cycleId,endDate,filledDataList,title,startDate)
